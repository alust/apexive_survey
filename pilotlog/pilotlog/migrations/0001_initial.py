    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('m_q_code', models.UUIDField(primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='Record',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pilotlog.record')),
            ],
        ),
        migrations.CreateModel(
            name='Pilot',
            fields=[
                ...
                ('pilot_e_mail', models.EmailField(max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_modified', models.PositiveIntegerField()),
                ('m_qb_code', models.UUIDField(primary_key=True, serialize=False)),
                ('m_q', models.ForeignKey(db_column='m_q_code', on_delete=django.db.models.deletion.CASCADE, to='pilotlog.myquery')),
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pilotlog.record')),
            ],
        ),
        migrations.AddField(
            model_name='myquery',
            name='record',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pilotlog.record'),
        ),
        migrations.CreateModel(
            name='LimitRules',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aircraft', models.ForeignKey(db_column='aircraft_code', on_delete=django.db.models.deletion.CASCADE, to='pilotlog.aircraft')),
                ('arr', models.ForeignKey(db_column='arr_code', on_delete=django.db.models.deletion.CASCADE, related_name='arr_set', to='pilotlog.airfield')),
                ('dep', models.ForeignKey(db_column='dep_code', on_delete=django.db.models.deletion.CASCADE, related_name='dep_set', to='pilotlog.airfield')),
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pilotlog.record')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            name='SettingConfig',
            fields=[
                ('config_code', models.CharField(max_length=36, primary_key=True, serialize=False)),
